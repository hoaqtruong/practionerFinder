...
$('#country-select').change( function() {
        ...
        if (this.value != selected_country ) {
          // countryClick expects an object as parameter with this structure,
          // so we create one here, even though we just want to pass the country's name:
          countryClick({properties: {name: this.value}})
